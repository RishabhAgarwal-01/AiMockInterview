...
function Interview({ params }) {
    ...
    return (
        <div className="my-10  flex-col items-center gap-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div>
                    {webCamEnabled ? (
                        ...
                        <>
                            <WebcamIcon className="h-72 w-full rounded-lg border my-7 bg-secondary" />
                            <Button className="w-full" onClick={() => setWebCamEnabled(true)}>
                                Enable Web Cam and Microphone (Recommended)
                            </Button>
                        </>
                    )}
